...
//    }
//
//    public B read(final GeometryInput input, final DoublePrecisionContext precision) throws IOException {
//        return requireReadHandler(input.getFormat())
//                .read(input, precision);
//    }
//
//    public Stream<H> boundaries(final GeometryInput input, final DoublePrecisionContext precision)
//            throws IOException {
//        return requireReadHandler(input.getFormat())
//                .boundaries(input, precision);
//    }
//
//    public void write(final B src, final GeometryOutput output) throws IOException {
//        requireWriteHandler(output.getFormat())
//                .write(src, output);
//    }
//
