...
public abstract class ModelWriteHandlerTestBase {
    ...
    protected abstract void assertEmptyOutput(byte[] output);

    protected abstract void assertSquareFacetOutput(byte[] output);

    protected abstract void assertCubeOutput(byte[] output);
}
