...
public class SimpleTextParser {
     ...
     * @throws IllegalStateException if no token has been read yet or the current token
     ...
     * @return this instance
     * @throws IllegalStateException if no token has been read or {@code expected} does not
     *      exactly equal the current token
     */
     ...
     * @return this instance
     * @throws IllegalStateException if no token has been read or {@code expected} does not
     *      equal the current token (ignoring case)
     */
     ...
     * @throws IllegalStateException if no token has been read or {@code expected} does
     *      not match the current token and {@code throwOnFailure} is true
     */
     ...
     * @throws IllegalStateException if no token has been read or no match is found among the
     *      arguments
     */
     ...
     * @throws IllegalStateException if no token has been read or no match is found and {@code throwOnFailure}
     *      is true
     */
    ...
    public IllegalStateException parseError(final int line, final int col, final String msg,
        ...
        final String fullMsg = String.format("Parsing failed at line %d, column %d: %s",
                line, col, msg);
        return new TextParseException(fullMsg, cause);
    }
    ...
    /** Exception class for errors occurring during text parsing.
     */
    private static final class TextParseException extends IllegalStateException {

        /** Serializable version identifier. */
        private static final long serialVersionUID = 20200830;

        /** Simple constructor.
         * @param msg the exception message
         * @param cause the exception root cause
         */
        TextParseException(final String msg, final Throwable cause) {
            super(msg, cause);
        }
    }
}
